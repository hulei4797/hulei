  ...
  $select1=$_POST['s1'];
  $php2=10;
  echo $select1+$php2."<---JS赋值给php，可以在PHP中进行编程";
   ?>
...
<body>
 ...
 <div class="am-g">
  ...
  $sql1 = "select count(car_id) from car where car_classify like '%旅游租车%'";
  ...
  $sql2 = "select * from car where car_classify like '%旅游租车%' limit $pre,$pageSize";
