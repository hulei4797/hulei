...
<body>
 ...
 <div class="am-g">
  ...
  $sql1 = "select count(car_id) from car where concat(car_name,car_classify,car_seat,car_type,car_price) like '%$text%'";
  ...
  $sql2 = "select * from car where concat(car_name,car_classify,car_seat,car_type,car_price) like '%$text%' limit $pre,$pageSize";
