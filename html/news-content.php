          ...
          <div class="nav-inner">
            <ul class="am-nav am-nav-pills am-nav-justify">
              ...
              <li>
                ...
                <!-- sub-menu start-->
                <ul class="sub-menu">
                  <li class="menu-item"><a href="product1.php">产品展示1</a></li>
                  <li class="menu-item"><a href="product2.php">产品展示2</a></li>
                  <li class="menu-item"><a href="product3.php">产品展示3</a></li>
                </ul>
                <!-- sub-menu end-->
              </li>
              <li><a href="example.php">客户案例</a></li>
              <li><a href="solution.php">解决方案</a></li>
              <li>
                <a href="news.php">新闻中心</a>
                <!-- sub-menu start-->
                <ul class="sub-menu">
                  <li class="menu-item"><a href="news-content.php">公司动态</a></li>
                  <li class="menu-item"><a href="404-dark.php">行业动态</a></li>
                  <li class="menu-item"><a href="404-light.php">精彩专题</a></li>
                </ul>
                <!-- sub-menu end-->
              </li>
                  ...
                  <li class="am-parent">
                    <a href="#" class="" >产品中心</a>
                      <ul class="am-menu-sub am-collapse ">
                          <li class="">
                            <a href="product1.php" class="" >产品展示1</a>
                          </li>
                          <li class="">
                            <a href="product2.php" class="" >产品展示2</a>
                          </li>
                          <li class="">
                            <a href="product3.php" class="" >产品展示3</a>
                          </li>
                      </ul>
                  </li>
                  <li class=""><a href="example.php" class="" >客户案例</a></li>
                  <li class=""><a href="solution.php" class="" >解决方案</a></li>
                  <li class="am-parent">
                    <a href="news.php" class="" >新闻中心</a>
                      <ul class="am-menu-sub am-collapse  ">
                          <li class="">
                            <a href="news-content.php" class="" >公司动态</a>
                          </li>
                          <li class="">
                            <a href="404-dark.php" class="" >行业动态</a>
                          </li>
                          <li class="">
                            <a href="404-light.php" class="" >精彩专题</a>
                          </li>
                      </ul>
                  </li>
