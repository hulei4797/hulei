...
<body>
 ...
 <div class="am-g">
  ...
  $sql1 = "select count(car_id) from car where car_classify like '%机场接送%'";
  ...
  $sql2 = "select * from car where car_classify like '%机场接送%' limit $pre,$pageSize";
  ...
  ?>
      ...
      echo "<a href='example.php?pageNow=$i'>$i</a> ";
    }?>&nbsp;共<?php
     echo $pageCount;
       ?>页</div>
        <?php }?>
